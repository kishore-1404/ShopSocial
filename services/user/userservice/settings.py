...
SECRET_KEY = 'django-insecure-6flzbckcx8sy6em0wn+lc)8-*u=8f3ubuhuy0$odqm01k@ok^w'
...
MIDDLEWARE = [
    ...
    'userservice.rate_limit_middleware.RateLimitMiddleware',
    'userservice.middleware.RequestLoggingMiddleware',
